...
router.get("/pokemon", function (req, res, next) {
  const param = {
    ...
    item11: { name: "けむりだま", effect: "野生のポケモンから必ず逃げられる" },
    item12: {
      name: "メタルコート",
      effect: "はがねタイプのわざの威力が上がる",
    },
    item13: { name: "たべのこし", effect: "ターン毎にHPが少しだけ回復する" },
    item14: {
      name: "でんきだま",
    ...
    item16: { name: "かたいいし", effect: "いわタイプのわざの威力が上がる" },
    item17: { name: "きせきのタネ", effect: "くさタイプのわざの威力があがる" },
    item18: { name: "くろいメガネ", effect: "あくタイプのわざの威力が上がる" },
    item19: { name: "くろおび", effect: "かくとうタイプのわざの威力が上がる" },
    item20: { name: "じしゃく", effect: "でんきタイプのわざの威力が上がる" },
    item21: {
      name: "しんぴのしずく",
    ...
    item35: { name: "ものしりメガネ", effect: "とくしゅわざの威力が上がる" },
    item36: {
      name: "たつじんのおび",
    ...
    item47: {
      name: "ねばりのかぎづめ",
      effect: "「しめつける」「まきつく」などでダメージを与えるターンが増える",
    },
    item48: {
      name: "くっつきバリ",
    ...
    item53: { name: "しずくプレート", effect: "みずタイプのわざの威力が上がる" },
    item54: {
      name: "いかずちプレート",
    ...
    item62: {
      name: "たまむしプレート",
      effect: "むしのタイプの石石盤。持たせるとむしタイプの技の威力が強まる。",
    },
    item63: {
      name: "がんせきプレート",
    ...
    item69: { name: "がんせきおこう", effect: "いわタイプのわざの威力が上がる" },
